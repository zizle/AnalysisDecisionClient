...
class MonthlyReport(ReportAbstract):
    def __init__(self, *args, **kwargs):
        ...
        # 获取报告
        self.get_monthly_reports()
        # 点击查询
        self.query_button.clicked.connect(self.get_monthly_reports)
        # 点击页码的事件
        self.paginator.clicked.connect(self.get_monthly_reports)
    ...
    def get_monthly_reports(self):
        ...
        url = SERVER_API + "report-file/paginator/?report_type=monthly&variety_en={}&page={}&page_size=50".format(current_variety, current_page)
